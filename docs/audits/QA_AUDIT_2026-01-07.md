...
|------|------|-------|--------|
| `src/agents/skills/sequence_builder.py` | 44 | `propensity_score >= 80` in example text | ✅ Fixed to 85 |
| `src/agents/skills/sequence_builder.py` | 126 | `propensity_score >= 80` in system prompt | ✅ Fixed to 85 |
| `src/agents/skills/sequence_builder.py` | 141 | `propensity_score >= 80` in comment | ✅ Fixed to 85 |
| `src/agents/skills/sequence_builder.py` | 423 | `propensity_score >= 80` in condition | ✅ Fixed to 85 |
...
**Change:** Updated `propensity_score >= 80` to `propensity_score >= 85`
...
grep -rn "propensity_score.*>= 80" src/
grep -rn "HOT.*85" src/
```
