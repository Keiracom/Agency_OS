...
COPY THIS FILE TO: src/agents/sdk_agents/sdk_tools.py
"""
...
async def web_search(
    ...
    Args:
        ...
        serper_api_key: Serper API key (uses env if not provided)
    ...
    # api_key = serper_api_key or settings.serper_api_key
...
async def linkedin_posts(
    ...
    # In production, get from settings:
    # from src.config.settings import settings
    # token = apify_token or settings.apify_token
