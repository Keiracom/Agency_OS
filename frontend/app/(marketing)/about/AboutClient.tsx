/**
 * FILE: app/(marketing)/about/AboutClient.tsx
 * PURPOSE: Client-side interactive content for About page
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-amber mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
