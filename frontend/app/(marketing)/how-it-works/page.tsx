...
export default function HowItWorksPage() {
 ...
 or pick up the phone, Agency OS captures the win, books the meeting, and updates your pipeline automatically.
                </p>
                <ul className="space-y-3">
                  {[
                    "Automatic calendar booking via Calendly/Cal.com",
                    "CRM integration (HubSpot, Pipedrive, Close)",
                    "Reply detection and sentiment analysis",
                    "Conversion Intelligence learns what works",
                  ].map((item, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <svg className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <ScrollReveal animation="fade-left" delay={100}>
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-8 border border-green-100">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <p className="font-semibold text-green-800">Meeting Booked!</p>
                    <p className="text-sm text-green-600">Discovery call scheduled</p>
                  </div>
                </div>
                <div className="bg-white rounded-xl p-4 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-[#1d1d1f]/50">Marketing Director, Bloom Digital</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 text-sm text-[#1d1d1f]/60 mb-3">
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    <span>Tomorrow at 2:00 PM AEST</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-xs px-2 py-1 rounded-full bg-blue-100 text-blue-600">Via LinkedIn</span>
                    <span className="text-xs px-2 py-1 rounded-full bg-green-100 text-green-600">Hot Lead (92)</span>
                  </div>
                </div>
              </div>
            </ScrollReveal>
