                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs font-light text-text-primary0 tracking-wider uppercase">
                        Agency Operating System
                      </span>
                    </div>
                  </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-xs font-light text-text-primary0 tracking-wider uppercase mt-2">
                      Agency Operating System
                    </span>
                  </div>
                </div>
