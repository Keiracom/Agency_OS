  ...
  return (
    <div className="bg-bg-surface border border-border-subtle rounded-2xl mb-6 overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-border-subtle flex items-center justify-between">
        ...
        <span className="text-sm text-text-muted">Resets {resetDate}</span>
      </div>
      ...
      <div className="p-6">
        <div className="grid grid-cols-3 gap-6">
          {/* Leads */}
          <div className="bg-bg-surface-hover rounded-xl p-5">
            <div className="flex justify-between items-start mb-4">
              <div className="text-sm font-semibold text-text-primary">Leads Contacted</div>
            ...
            <div className="flex items-baseline gap-1 mb-3">
              <span className="text-[28px] font-extrabold font-mono text-text-primary">{usage.leads.current.toLocaleString()}</span>
              <span className="text-base text-text-muted font-mono">/ {usage.leads.max.toLocaleString()}</span>
            </div>
          ...
          <div className="bg-bg-surface-hover rounded-xl p-5">
            <div className="flex justify-between items-start mb-4">
              <div className="text-sm font-semibold text-text-primary">Meetings Booked</div>
            ...
            <div className="flex items-baseline gap-1 mb-3">
              <span className="text-[28px] font-extrabold font-mono text-text-primary">{usage.meetings.current}</span>
              <span className="text-base text-text-muted font-mono">/ {usage.meetings.targetMin}-{usage.meetings.targetMax}</span>
            </div>
            <div className="h-2 bg-bg-elevated rounded overflow-hidden mb-2">
              <div
          ...
          <div className="bg-bg-surface-hover rounded-xl p-5">
            <div className="flex justify-between items-start mb-4">
              <div className="text-sm font-semibold text-text-primary">New Clients Won</div>
            ...
            <div className="flex items-baseline gap-1 mb-3">
              <span className="text-[28px] font-extrabold font-mono text-text-primary">{usage.clients.current}</span>
              <span className="text-base text-text-muted font-mono">/ {usage.clients.targetMin}-{usage.clients.targetMax}</span>
            </div>
            <div className="h-2 bg-bg-elevated rounded overflow-hidden mb-2">
              <div
                className="h-full rounded bg-gradient-to-r from-accent-teal to-status-success transition-all duration-500"
