  ...
  return (
    <div className={cn("fixed bottom-6 right-6 z-50", className)}>
      ...
      {isOpen && currentMayaStep && (
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#7C3AED] to-[#9D5CFF] flex items-center justify-center text-ink font-bold shadow-lg shadow-amber/30">
              M
            </div>
            <div>
          ...
          <div className="flex gap-2">
            <button
              onClick={handleNext}
              className="flex-1 px-4 py-2.5 bg-[#7C3AED] hover:bg-[#9D5CFF] text-ink text-sm font-medium rounded-lg transition-colors"
            >
      ...
      <button
        ...
        className={cn(
          "w-16 h-16 rounded-full bg-gradient-to-br from-[#7C3AED] to-[#9D5CFF] border-[3px] border-[#12121A] shadow-lg shadow-amber/40 flex items-center justify-center text-ink text-2xl font-bold transition-transform hover:scale-105",
