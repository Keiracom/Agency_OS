    ...
    return (
      <Card className={cn("bg-[#1a1a1f] border-white/10", className)}>
        <CardContent className="p-6">
          <div className="text-ink/60 text-center py-4">
    ...
    <Card className={cn("bg-[#1a1a1f] border-white/10", className)}>
      <CardContent className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6">
          ...
          <div className="space-y-2">
            <Skeleton className="h-4 w-32 bg-bg-panel/10" />
            <Skeleton className="h-10 w-20 bg-bg-panel/10" />
            <Skeleton className="h-6 w-40 bg-bg-panel/10" />
          </div>
          {/* Show Rate skeleton */}
          <div className="space-y-2">
            <Skeleton className="h-4 w-24 bg-bg-panel/10" />
            <Skeleton className="h-10 w-16 bg-bg-panel/10" />
            <Skeleton className="h-4 w-32 bg-bg-panel/10" />
          </div>
        </div>
      </CardContent>
