          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-slate-700/50 bg-slate-800/30">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Your Digital Employee</p>
              </div>
            </div>
            <button
            ...
            <div className="p-5">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 px-4 py-2.5 bg-purple-600 hover:bg-purple-500 text-white text-sm font-medium rounded-lg transition-colors flex items-center justify-center gap-2"
                >
                ...
                <div className="flex flex-wrap gap-2">
                  {pageContext.suggestions.slice(0, 3).map((suggestion, i) => (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-800/60 hover:bg-slate-700/60 border border-slate-600/30 rounded-full text-xs text-slate-300 hover:text-white transition-colors"
                    >
                      {suggestion.icon}
                      {suggestion.label}
                    </button>
              ...
              <div className="p-4 pt-0">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 bg-slate-800/60 border border-slate-600/50 rounded-xl text-sm text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/20 transition-colors"
                  />
                  <button
