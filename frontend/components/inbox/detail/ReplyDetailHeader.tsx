  ...
  return (
    <header className="bg-surface-dark border-b border-border-subtle px-6 py-3 flex items-center gap-4">
      <Link
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-text-muted hover:bg-bg-surface/[0.05] hover:text-text-secondary transition-colors"
      >
