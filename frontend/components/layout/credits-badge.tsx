...
export function CreditsBadge({ className }: CreditsBadgeProps) {
  ...
  const variantStyles = {
    default: "bg-amber-glow text-green-800 hover:bg-amber-glow dark:bg-green-900 dark:text-green-200",
    warning: "bg-yellow-100 text-yellow-800 hover:bg-yellow-100 dark:bg-yellow-900 dark:text-yellow-200",
    destructive: "bg-amber-glow text-red-800 hover:bg-amber-glow dark:bg-red-900 dark:text-red-200",
  };
