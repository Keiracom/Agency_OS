  ...
  return (
    <div className="bg-bg-base border border-default rounded-xl overflow-hidden">
      <div className="px-5 py-4 border-b border-default flex items-center gap-2">
        ...
        <h3 className="text-sm font-semibold text-text-primary">ROI Summary</h3>
      </div>
      <div className="p-5">
        <div className="grid grid-cols-3 gap-4">
          {/* Spend */}
          <div className="bg-bg-void rounded-lg p-4 text-center">
            <p className="text-3xl font-extrabold font-mono text-amber">
              ${(roiSummary.spend / 1000).toFixed(0)}K
            </p>
            <p className="text-[10px] text-text-muted uppercase tracking-wider mt-1">Total Spend</p>
          </div>
          {/* Pipeline */}
          <div className="bg-bg-void rounded-lg p-4 text-center">
            ...
            <p className="text-[10px] text-text-muted uppercase tracking-wider mt-1">Pipeline Generated</p>
          </div>
          {/* ROI */}
          <div className="bg-bg-void rounded-lg p-4 text-center">
            ...
            <p className="text-[10px] text-text-muted uppercase tracking-wider mt-1">Return on Investment</p>
          </div>
        </div>
      </div>
    </div>
