  ...
  return (
    <div className="glass-surface border border-border-subtle rounded-xl overflow-hidden">
      <div className="px-6 py-5 border-b border-border-subtle flex items-center gap-2.5">
        ...
        <span className="font-serif font-semibold text-text-primary">Notification Preferences</span>
      </div>

      <div className="p-6">
        <div className="flex flex-col gap-4">
          {preferences.map((pref) => (
            <div key={pref.id} className="flex items-center justify-between px-5 py-4 bg-bg-surface-hover rounded-xl">
