...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[40rem] w-full items-center justify-center bg-bg-surface dark:bg-black",
        containerClassName,
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-indigo-300 to-amber-light px-1 pb-1 dark:from-indigo-500 dark:to-amber`,
        className,
      )}
    >
      {children}
