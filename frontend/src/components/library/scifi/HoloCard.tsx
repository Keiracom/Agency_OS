  ...
  return (
    <div className="relative w-full h-full min-h-[300px] p-1">
      ...
      >
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-2 text-center">
                {["SYNC", "LOAD", "TEMP"].map((label, i) => (
                  <div key={label} className="bg-cream/50 border border-amber/20 rounded p-2">
        ...
        {/* Footer status bar */}
        <div className="absolute bottom-0 left-0 right-0 h-6 bg-cream/80 border-t border-amber/20 flex items-center px-3 justify-between">
