...
def get_action_label(action_type: ActionType) -> str:
    ...
    return {
        ...
        ActionType.ABSORB: "Knowledge Absorption",
...
def format_signoff_message(request: SignoffRequest) -> str:
    ...
    The summary field now contains the full rich description generated by
    action_engine.generate_description(), so we display it directly.
    """
    # The summary now contains the full formatted message including emoji and header
    # We just add the ID footer
