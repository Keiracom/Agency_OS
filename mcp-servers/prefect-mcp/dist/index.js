...
async function prefectRequest(endpoint, method = "GET", body) {
    const headers = {
...
const server = new Server({ name: "prefect-mcp", version: "1.0.0" }, { capabilities: { tools: {} } });
    ...
    try {
        switch (name) {
            ...
            case "trigger_run": {
                ...
                const run = await prefectRequest(`/deployments/${deploymentId}/create_flow_run`, "POST", { parameters });
                return {
