...
const server = new Server({ name: "railway-mcp", version: "1.0.0" }, { capabilities: { tools: {} } });
        ...
        `, { serviceId });
                ...
                return {
                    content: [
                        {
                            type: "text",
                            text: JSON.stringify({ service: data.service.name, latestDeployment: deployment }, null, 2),
                        },
                    ],
                };
            }
