...
**Problem:** We need to enrich ICP with social media data for a more impressive profile.
...
Follow the existing pattern in `scrape_website()` for actor calls and error handling.
