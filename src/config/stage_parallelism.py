...
STAGE_PARALLELISM: dict[str, StageConfig] = {
    ...
    "stage_f6_enhanced_vr": {
        "stage_name": "F6 — Enhanced VR (second Gemini call on qualified prospects)",
        "concurrency": 10,
        "provider": "gemini",
        "provider_ceiling": 30,
        "safety_margin": 0.33,
        "notes": "Second Gemini 2.5 Flash call. Only fires for prospects passing candidacy gate. Regenerates VR + messages with DM post context.",
    },
    "dfs_global": {
