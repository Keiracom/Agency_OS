...
# NOTE: SDK agents deprecated per FCO-002. Hot lead processing now via Siege Waterfall.
# Removed: email_agent, enrichment_agent, voice_kb_agent imports
...
# NOTE: SDK agent tasks removed per FCO-002
# sdk_enrich_hot_assignment_task, sdk_generate_email_for_assignment_task,
# sdk_generate_voice_kb_for_assignment_task - all deprecated.
# Hot lead processing now handled by Siege Waterfall pipeline.
...
async def lead_enrichment_flow(
    ...
    # NOTE: Stage 5 (SDK processing) removed per FCO-002.
    # Hot lead enrichment/email/voice-kb now handled by Siege Waterfall pipeline.
