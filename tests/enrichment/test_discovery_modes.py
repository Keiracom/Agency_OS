...
class TestMapsFirstDiscovery:
    ...
    async def test_uses_bright_data_serp(self):
        from enrichment.discovery_modes import MapsFirstDiscovery, CampaignConfig, DiscoveryMode
...
class TestParallelDiscovery:
    ...
    async def test_runs_both_modes(self):
        from enrichment.discovery_modes import ParallelDiscovery, CampaignConfig, DiscoveryMode
