...
class IntegrationTestResult:
    ...
    def __init__(self, lead: dict):
        ...
        self.gmb_rating: Optional[float] = None
        
        # DM data
        self.dm_name: Optional[str] = None
        self.dm_title: Optional[str] = None
        self.dm_linkedin_url: Optional[str] = None
        
        # Social intelligence
        self.linkedin_posts: list[dict] = []
        self.x_handle: Optional[str] = None
