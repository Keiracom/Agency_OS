...
# --- Wave 1 signal verification tests (item #10 — wire unused scoring signals) ---
...
def test_no_paid_traffic_scores_higher_than_paid():
    ...
    Note: confidence_scorer.py uses the inverse (spend > 0 = budget signal for business health).
    The opportunity scorer intentionally rewards ABSENCE of paid traffic — it's an agency gap score.
    """
    base = {
        "gmb_review_count": 20,
        "abr_age_years": 3,
...
def test_abr_age_5_scores_higher_than_age_below_5():
    ...
    Signal already wired at line 72-74 of opportunity_scorer.py (+20 points).
    """
    base = {
        "gmb_review_count": 20,
        "dfs_paid_traffic_cost": 1,
